...
HD_PWD='C:/FPGA/CS223_Lab2/CS223_Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_shifter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit_shifter.tcl
