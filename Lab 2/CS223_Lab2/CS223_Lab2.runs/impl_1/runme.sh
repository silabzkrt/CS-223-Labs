...
HD_PWD='C:/FPGA/CS223_Lab2/CS223_Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit_shifter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit_shifter.tcl -notrace
