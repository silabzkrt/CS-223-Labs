...
HD_PWD='C:/FPGA/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ParkingSystem_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ParkingSystem_Top.tcl
