...
HD_PWD='C:/FPGA/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ParkingSystem_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ParkingSystem_Top.tcl -notrace
