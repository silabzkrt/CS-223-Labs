...
HD_PWD='C:/FPGA/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_part1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_part1.tcl -notrace
